...
(function () {
    ...
    /* ==========================================================================
       RATINGS MODULE
       ========================================================================== */
    const CACHE_RATINGS = 'cp_ratings_v4';
    ...
    async function fetchAcRating() {
        try {
            const res = await fetchTimeout(
                'https://kenkoooo.com/atcoder/atcoder-api/v3/user/submissions?user=aryanmoorthy&from_second=0'
            );
            if (!res.ok) throw new Error(`HTTP ${res.status}`);
    ...
    async function initRatings() {
        ...
        try {
            ...
            applyRatings({
                cf: { rating: 1180, maxRating: 1180, rank: 'pupil', solved: '900+' },
                cc: { rating: 1415, maxRating: 1511, stars: 2, contests: 8 },
                ac: { rating: 669, contests: null }
            });
        }
    }
